  ...
  faqs: [
    {
      ...
      answer:
        "The t-shirt is crafted from soft and breathable fabric, ensuring superior comfort and style.",
    },
    {
      question: "What colors are available for this t-shirt?",
      answer:
        "The t-shirt is available in three colors: Green, Dark Green, and Dark Blue.",
    },
    {
      question: "What sizes can I choose from?",
      answer:
        "The t-shirt comes in four sizes: Small, Medium, Large, and X-Large.",
    },
    {
      question: "Does this t-shirt shrink after washing?",
      answer:
        "Some reviews mention slight shrinkage after the first wash, so it's recommended to follow care instructions carefully.",
    },
    {
      question: "Is the print quality durable after multiple washes?",
      answer:
        "According to reviews, the print quality is top-notch and remains vibrant even after multiple washes.",
    },
    {
      question: "What is the discount currently being offered?",
      answer:
        "The t-shirt is available at a 40% discount, bringing the price down to $260 from its original price of $300.",
    },
    {
      question: "Is the size accurate to the standard size chart?",
      answer:
        "Most customers found the fit accurate, but a few reviews mention that the size runs slightly small.",
    },
    {
      question: "Are there any additional details about the product?",
      answer:
        "Yes, the t-shirt is versatile and suitable for casual or semi-formal wear. It's available in multiple colors and sizes, making it a great choice for any occasion.",
    },
    {
      question: "Can I return or exchange the t-shirt if it doesn't fit?",
      answer:
        "Please refer to our return and exchange policy for detailed information on returns and exchanges.",
    },
    {
      question: "Are customer reviews verified?",
      answer:
        "Yes, most reviews are from verified customers. Verified reviews ensure authentic feedback from genuine buyers.",
    },
  ],
